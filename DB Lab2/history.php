...
echo " | ";
echo "<a href=\"liveSearch.php?userString=$searchString?userString2=$searchString2\">View the latest tweets about $searchString</a><br />";
...
$theQuery = 'select * from tweets2 where tweet_text like \'%'.$searchString2.'%\''; // build SQL table query
$result = mysqli_query($connection, $theQuery) or die(mysqli_error($connection)); // perform query
